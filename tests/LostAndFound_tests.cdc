...
access(all) fun trySendNft(_ acct: Test.TestAccount): UInt64 {
...
access(all) fun trySendFt(_ acct: Test.TestAccount, _ amount: UFix64) {
...
access(all) fun trySendNftWithDepositor(_ to: Test.TestAccount): UInt64 {
...
access(all) fun trySendFtWithDepositor(_ to: Test.TestAccount, _ amount: UFix64) {
